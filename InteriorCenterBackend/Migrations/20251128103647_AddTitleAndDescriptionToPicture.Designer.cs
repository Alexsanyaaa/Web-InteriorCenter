...
namespace InteriorCenterBackend.Migrations
{
    ...
    [Migration("20251128103647_AddTitleAndDescriptionToPicture")]
    partial class AddTitleAndDescriptionToPicture
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InteriorCenterBackend.Models.Picture", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("InteriorCenterBackend.Models.Review", b =>
                {
                    b.HasOne("InteriorCenterBackend.Models.Product", null)
                        .WithMany("Reviews")
            ...
            modelBuilder.Entity("OrderItem", b =>
                {
                    b.HasOne("InteriorCenterBackend.Models.Order", null)
                        .WithMany("OrderItems")
