...
namespace InteriorCenterBackend.Migrations
{
    ...
    [Migration("20251120201502_Migration5")]
            ...
            modelBuilder.Entity("InteriorCenterBackend.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2025, 11, 20, 10, 0, 0, 0, DateTimeKind.Utc),
                            Description = "Гибкая система мебели, которую можно адаптировать под любую планировку. Материал: ЛДСП. Цвета: на выбор.",
                        ...
                        new
                        {
                            Id = 11,
                            CreatedAt = new DateTime(2025, 11, 20, 10, 0, 0, 0, DateTimeKind.Utc),
                            Description = "Современный комплект с интересным дизайном. Включает кровать, письменный стол, шкаф и полки. Материал - ЛДСП. Цвет - Крафт-серый. Удобно и стильно.",
                        ...
                        new
                        {
                            Id = 14,
                            CreatedAt = new DateTime(2025, 11, 20, 10, 0, 0, 0, DateTimeKind.Utc),
                            Description = "Открытая конструкция для книг, декоративных предметов и игрушек. Материал - ЛДСП. Цвет - Бук. Размеры: 100х30х180 см. Современный дизайн.",
                        ...
                        new
                        {
                            Id = 17,
                            CreatedAt = new DateTime(2025, 11, 20, 10, 0, 0, 0, DateTimeKind.Utc),
                            Description = "Удобный стул с мягким сиденьем и деревянным каркасом. Материал сиденья - ткань. Цвет - серый. Идеально подходит для кухни или рабочего места.",
                        ...
                        new
                        {
                            Id = 20,
                            CreatedAt = new DateTime(2025, 11, 20, 10, 0, 0, 0, DateTimeKind.Utc),
                            Description = "Просторная гостиная с угловым диваном, обеспечивающим комфорт для большого количества людей. В комплект входят: диван, столик, ТВ-тумба. Материал - ткань, ЛДСП. Цвет - серый.",
